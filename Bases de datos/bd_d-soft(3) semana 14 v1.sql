...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-09-2017 a las 21:49:25
...
CREATE TABLE `persona` (
  ...
  `numeroTelefonico` int(50) NOT NULL,
...
INSERT INTO `persona` (`cedula`, `password`, `nombre`, `correo`, `empresa`, `cargo`, `numeroTelefonico`, `tipoUsuario`) VALUES
('321', 'bcfa46440609c8d27740964e2bd42295', 'Armando', 'armando@gmail.com', 'ctp carrizal', 'administrador', 88888888, 1),
('2098484484', 'bcfa46440609c8d27740964e2bd42295', 'Juany', 'juany@gmail.com', 'intel', 'janitor', 2147483647, 2);
